    ...
    <div className="min-h-screen bg-mybha-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <img src="/logo.png" alt="MyBHA" className="inline-block w-28 h-28 rounded-2xl mb-4 shadow-lg" />
          <h1 className="text-2xl font-bold text-white">MyBHA</h1>
          <p className="text-mybha-gold text-sm mt-1">Muslim Friendly Hospitality</p>
          <p className="text-white/40 text-[10px] mt-0.5">by HQC Shariah Advisory</p>
        </div>
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          MyBHA © {new Date().getFullYear()} · MFHC Certification System
        </p>
      </div>
    </div>
  )
